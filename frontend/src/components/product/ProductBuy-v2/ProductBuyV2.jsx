...
import Toast from 'bootstrap/js/dist/toast'; // Import only the Toast component

function ProductBuyV2({ product, userId }) {
        ...
        <>
            <div className="col-4 bg-body">
                ...
                <div className="w-100 mt-2 gap-2 d-flex flex-column">
                    ...
                    <SecundaryBtn onClick={() => handleAdd()} text={"Agregar al carrito"} loading={loading} />
                </div>
            </div>
